export const mockProductDetailData = {
  standardProduct: {
    product: {
      ...
      images: [
        "https://via.placeholder.com/600x600/007bff/ffffff?text=Speaker+Front",
        "https://via.placeholder.com/600x600/0056b3/ffffff?text=Speaker+Side",
        "https://via.placeholder.com/600x600/003366/ffffff?text=Speaker+Back",
      ],
      rating: 4.5,
      reviewCount: 120,
      variants: [
  ...
  galleryProduct: {
    product: {
      ...
      images: [
        "https://via.placeholder.com/900x600/28a745/ffffff?text=Smartwatch+Display",
        "https://via.placeholder.com/900x600/218838/ffffff?text=Smartwatch+Side",
        "https://via.placeholder.com/900x600/1e7e34/ffffff?text=Smartwatch+Band",
        "https://via.placeholder.com/900x600/17662c/ffffff?text=Smartwatch+Features",
      ],
      rating: 4.8,
      reviewCount: 85,
      variants: [
  ...
  reviewsProduct: {
    product: {
      ...
      images: [
        "https://via.placeholder.com/700x700/ffc107/000000?text=Monitor+Front",
        "https://via.placeholder.com/700x700/e0a800/000000?text=Monitor+Setup",
      ],
      rating: 4.2,
      reviewCount: 230,
      variants: [
