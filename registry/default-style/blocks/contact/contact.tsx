    ...
    <section className={cn("w-full py-12 md:py-24 lg:py-32", className)} {...props}>
      <div className="container px-4 md:px-6">
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          ...
          <Card className={cn("p-6", (variant === "basic-form" || variant === "form-with-info") ? "md:col-span-1 lg:col-span-1" : "md:col-span-2 lg:col-span-2")}>
            <CardHeader>
          ...
          {variant === "form-with-map" && (
            <Card className="flex flex-col p-6 md:col-span-1 lg:col-span-1">
              <CardHeader>
