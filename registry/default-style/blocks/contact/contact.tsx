  ...
  return (
    ...
    >
      <div className="container px-4 md:px-6">
        ...
        <motion.div className="grid gap-8 md:grid-cols-1 lg:grid-cols-1" variants={containerVariants}>
          ...
          <motion.div variants={itemVariants} className={cn((variant === "basic-form" || variant === "form-with-info") ? "md:col-span-1 lg:col-span-1" : "md:col-span-2 lg:col-span-2")}>
